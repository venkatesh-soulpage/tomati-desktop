...
export const FORGOT_PASSWORD = "/api/tomati/tomati-forgot";
export const RESET_PASSWORD = "/api/tomati/reset";
export const VERIFY_CREDENTIALS = "/api/tomati/verify-credentials";
export const GET_USER = "/api/accounts/me";
export const UPDATE_USER = "/api/tomati/reset-profile";
export const GET_ALL_USERS = "/api/tomati/get-all-users";
...
export const GET_USER_LIMIT = "/api/tomati/retrive-subscription";

//Outlets
export const GET_OUTLETS = "/api/tomati/user-venues";
export const TOGGLE_MENU = "/api/outletvenues";
export const UPDATE_MENU_STATUS = "/api/tomati/update_menu_status";
export const GET_OUTLET = "/api/outletvenues";
export const ADD_OUTLET_REQUEST = "/api/outletvenues";
export const ADD_OUTLET_COLLABORATOR = "/api/tomati/invite-collaborator";
